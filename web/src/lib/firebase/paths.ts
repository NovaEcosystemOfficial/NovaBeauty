...
export const suppliersPath = (userId: string) => `novabeautyUsers/${userId}/suppliers`;
export const stockMovementsPath = (userId: string) => `novabeautyUsers/${userId}/stockMovements`;
